...
//        String text = "Hello world";       //Метод обрезания .substring
//        System.out.print(text.substring(0,8).replace('l','r').toUpperCase());

        //Задача//Создать метод маскирования персональных данных, который: //пока не мой уровень, много нового 13.03.24
...
//        //Регулярные выражения, класс StringBuilder
        ...
        //Задача//Вычислить следующую часть кода, сперва в блокноте, потом сравнить ответ с программой
...
//        System.out.println(result);//-16,7
        ...
        // a-- - --a + ++a + a++ + a; где a=5; // ответ уровнения = 15; a конечная = 5;
        // 5 - 3 + 4 + 4 + 5 = 15
        // ++b - b++ + ++b - --b; где b=8;     // ответ уровнения = 1; b конечная = 10;
        // 9 - 9 + 11 - 10 = 1
